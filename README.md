...
Un simple proyecto Django para registrar diferentes tipos de mascotas (perros, gatos y pájaros).
...
1. Primero agrega algunas mascotas usando los formularios en las páginas de perros, gatos y pájaros
2. Luego ve a la página de búsqueda para encontrar las mascotas por nombre 